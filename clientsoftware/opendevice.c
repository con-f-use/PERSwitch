/* Tabsize: 4, Encoding: UTF-8, Language: C99/English, Linux-Style linebreaks */
/**
 * \file opendevice.c
 * Source file to the header file opendevice.h.
 *
...
#define MATCH_SUCCESS   1   ///< Internal return code for a found device
#define MATCH_FAILED    0   ///< Internal error code for device not found
#define MATCH_ABORT     -1  ///< Internal error code for aborted device search

/**
 * Private interface: match text and p
 * \return MATCH_SUCCESS, MATCH_FAILED, or MATCH_ABORT.
 */
 ...
 * \return 0 if fails, 1 if matches
 */
