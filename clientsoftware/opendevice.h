 ...
 *
 * To use this functionality, simply copy opendevice.c and opendevice.h into
 * your project and add them to your Makefile. You may modify and redistribute
 * these files according to the GNU General Public License (GPL) version 2 or 3.
 *
 ...
 * \version $Id: opendevice.h 755 2009-08-03 17:01:21Z cs $
 */
 ...
 *
 * \param dev libusb device handle for the device
 * \param index The string descriptor index.
 * \param buf Contains the string in ISO Latin 1 encoding terminated with a
 * 0-character.
 * \param buflen length of the buffer
 *
 * \return length of the string (excluding the terminating 0) or
 ...
 *
 * \return 0 on success, an error code (see defines) on failure.
 */
